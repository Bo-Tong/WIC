...
const parseFmtpLine = (fmtpLine: string): { pt: string; params: any } | null => {
  const fmtpObj: { pt: string; params: any } = { pt: '', params: '' };
...
export const reorderCodecs = (sdp?: string, type?: string, codecs?: string[], mid?: string): string | undefined => {
